...
export default () => {
    ...
    return <>
        <div class="fixed top-0 inset-x-0 bg-slate-200 dark:bg-slate-800 flex flex-col" style={`bottom:${user.value?'60px':'0'}`}>{home()}</div>
