...
export default () => {
    ...
    signals.syncDone = useSignal(false);
    ...
    return <>
        ...
        {signals.tips.value && <div class="fixed top-[38px] inset-x-0 p-2 bg-yellow-300 text-slate-800 flex justify-center items-center" onClick={hideTips}>{signals.tips.value}</div>}
    </>;
}